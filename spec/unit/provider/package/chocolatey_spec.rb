...
munin-node|1.6.1.20130823
    ...
    arglist = [ package_names, args ].flatten.compact
    allow(provider).to receive(:shell_out!).with(choco_exe, "list", "-r", *arglist, { :returns => [0], timeout: timeout }).and_return(remote_list_obj)
  end
